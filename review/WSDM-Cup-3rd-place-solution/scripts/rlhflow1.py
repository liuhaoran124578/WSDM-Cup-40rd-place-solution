...
random.seed(42)
dataset1 = load_dataset("RLHFlow/Helpsteer-preference-standard", split="train")
...
for dd in tqdm(dataset1):
    ...
    if random.random() > 0.5:
        ...
        response_b = r_chosen
    new_id = "RLHFlow/Helpsteer-preference-standard" + '-' + str(ct)
...
new_df.to_csv('other-external/HelpSteer.csv', index=False)
print('a')